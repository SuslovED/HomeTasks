...
## Описание  
Данный набор программ реализует базовые численные алгоритмы и работу со вводом/выводом в языке C без использования сторонних библиотек.  
...
- базовые алгоритмы численных вычислений;  
- работа со строками и вводом/выводом;  
- минимизация зависимостей (только `<stdio.h>`, `<ctype.h>`).  

---

## Автор
**Егор Суслов**  
[GitHub репозиторий](https://github.com/SuslovED/HomeTasks)
